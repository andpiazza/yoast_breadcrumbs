...
1.**Implement breadcrumbs**: place the code at the end of your theme's headers.php
...
1. **Make the last element of the breadcrumb (post or page title) not show via CSS**
